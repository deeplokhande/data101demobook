# Data Modeling and Prediction. {#modeling}
...
- `rpart( _formula_ , _method_, _data_, _control_,...)`
...
rpart.plot(tree)
```
![Output Plot of *rpart.plot()* function](../files/img/modeling/rpartplot1.svg)
...
![Output Plot of *prp()* function](../files/img/modeling/prp1.svg)
...
```
![Output tree plot of after setting minsplit=200 in rpart.control() function](../files/img/modeling/rcontrolsplit.svg)
...
```
![Output tree plot of after setting minbucket=100 in rpart.control() function](../files/img/modeling/rcontrolbucket.svg)
...
```
![Output tree plot of after setting cp=0.005 in rpart.control() function](../files/img/modeling/rcontrolcp.svg)
