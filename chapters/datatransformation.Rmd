...
This section will involve use of the _table()_ and _tapply()_ function more to apply the functions like `mean, count, sum, etc` on the subsets categorical or numerical columns.
