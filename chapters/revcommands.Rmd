...
Now lets look at how to coerce data into dataframe.

Suppose in the Moody dataset, I want to change the categorical vector of letter grade to numeric grades between 1 to 5, where A=1, B=2, ..., F=5.
