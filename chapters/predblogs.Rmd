...
The data consists of creating subset of the dataset based on attributes to include easier patterns.

For the data, the first subsetting is done on the basis of the *Major* attribute of the Moody Dataset. And following that each subset has its own sub divisions where you can find clear distinct sets with pass/fail grade students.
...
NOTE: The data was stochastically generated.
