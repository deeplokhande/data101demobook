...
Permutation test also know as "Randomization Test", is a type of statistical significance test in which the distribution of the test statistic under null hypothesis is obtained by calculating all possible values of the test statistic under all possible rearrangements of observed data points. 
...
- Now keep the same means and change the variances. See how changing the variances in rnorm() will affect the p-value and try to explain the effect that standard deviations have on the p-value.
