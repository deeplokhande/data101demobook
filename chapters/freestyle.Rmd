...
Through this section we will use our usual inital example, of synthetically generate data describing mysterious methods of grading used by an excentric Professor Moody. We have been using different versions of this *data puzzle* over the 6 years of teaching data 101. Data is different but narrative is always the same:
