...
### Ideal Solution for Challenge 1

The ideal solution consists of subsetting the dataset based on attributes to find a easier patterns.

For the solution, the first subsetting is done on the basis of the *Major* attribute of the Moody Dataset. And following that each subset has its own sub divisions where you can find clear distinct sets with pass/fail grade students.

The ideal answer is based on a tree given by the following conditions:
...
- **Ideal Solution using R on the testing dataset**
  - You can see a simple way to write the solution using the above patterns to predict the grade of students.
...
- **Ideal solution using R for prediction challenge 2**
...
### Ideal Solution for Challenge 3

In this challenge, the Earnings variable was calculated using the attributes like GPA, Connections and Graduation Year in some case.

Again, the main attribute on which the problem can be subsetted is the Eduacation attribute.
...
### Ideal solution for Challenge 4
...
- **Possible Solution for Challenge 4 in R**

**NOTE**: This is not an Ideal solution for Challenge 4, since most of the data was stochastically generated.
